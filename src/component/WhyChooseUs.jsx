    ...
    <div className='choose mt-5 ' >
        <div className="choose-container container">
            <div className="row " ref={servicesRef}>
                ...
                <div className="value-card col-md-6 col-lg-3 col-sm-12 text-center service1">
                ...
                <div className="value-card col-md-6 col-lg-3 col-sm-12 text-center  service1">
                    <div className='value-card1'>
                        ...
                        <p className='para  pt-1'>At SKYERS Group, we believe in providing exceptional customer service that goes above and beyond. That's why our dedicated team is available 24/7 to assist you with any questions, concerns, or support needs you may have. With SKYERS Group, you're not just a client – you're a valued partner, and we're here to support you every step of the way.</p>
                    </div>
